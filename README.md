...
- [x] Explain what a token is used for.
      A:  A token is used to authenticate users, to ensure only those who are approved is/are about to gain access.

- [x] What steps can you take in your web apps to keep your data secure?
      A: Using protected routes, use https,  encrypted tokens

- [x] Describe how web servers work.
      A: A series of computers that store data that are connected to the web.
